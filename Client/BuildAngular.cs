    ...
    public static class BuildAngular
    {
        ...
        public static void Setup(string gatewayServer)
        {
            angular.Module("acg", new string[] {"ui.utils", "ui.codemirror"})
                ...
                .Directive(AcgSpacesDirective.Name,
                    new object[] {CompileName, GameContentManagerService.Name, new Func<CompileService, GameContentManagerService, object>((compile, gameContentManager) => new AcgSpacesDirective(compile, gameContentManager))})
