        ...
        public static void Setup(string gatewayServer)
        {
            angular.module("acg", new string[] { "ui.utils", "ui.codemirror" })
                ...
                .config(new object[] { "$routeProvider", new Action<IRouteProviderProvider>(buildRouteProvider) })
                 ...
                 .controller("DebugGameController", new object[] { "$scope", "clientDebugManager", "gameContentManager","createUIService", new Func<DebugGameControllerScope, ClientDebugManagerService, GameContentManager, CreateUIService, object>((scope, clientGameManagerService, gameContentManager, createUIService) => new DebugGameController(scope, clientGameManagerService, gameContentManager, createUIService)) })
                 ...
                 .controller("DebugQuestionController", new object[] { "$scope", "UIManager", "clientGameManager", new Func<QuestionScope, UIManagerService, ClientGameManagerService, object>((scope, uiManager, clientGameManagerService) => new DebugQuestionController(scope, uiManager, clientGameManagerService)) })
                 ...
                 .controller("GameEditorController", new object[] { "$scope", "UIManager", "clientSiteManager", "clientDebugManager", "messageService", "createUIService", new Func<GameEditorScope, UIManagerService, ClientSiteManagerService, ClientDebugManagerService, MessageService, CreateUIService, object>((scope, uiManagerService, clientSiteManagerService, clientDebugManagerService, messageService, createUIService) => new GameEditorController(scope, uiManagerService, clientSiteManagerService, clientDebugManagerService, messageService, createUIService)) })
                 ...
                 .service("UIManager", new object[] { "clientGameManager", new Func<object>(() => new UIManagerService()) })
