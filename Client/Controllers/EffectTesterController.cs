...
namespace Client.Controllers
{
    public class EffectTesterController
    {
        ...
        public EffectTesterController(EffectTesterControllerScope scope)
        {
            ...
            scope.Model.SpaceTest.Space = new GameSpaceModel() { Guid = Guid.NewGuid(), Left = 3, Top = 3, Height = 2, Width = 7, LayoutType = GameSpaceLayoutType.Grow, Name = "SpaceTest", Vertical = false };
            ...
            scope.Model.CardTest.Space = new GameSpaceModel() { Guid = Guid.NewGuid(), Left = 3, Top = 8, Height = 2, Width = 7, LayoutType = GameSpaceLayoutType.Grow, Name = "CardTest", Vertical = false };
            ...
            scope.Model.AreaTest.Area = new GameAreaModel() { Guid = Guid.NewGuid(), Left = 3, Top = 6, Height = 2, Width = 2, Name = "AreaTest" };

            scope.Model.TextTest = new EffectTesterTextModel();
            scope.Model.TextTest.Text = new GameTextModel() { Guid = Guid.NewGuid(), Left = 7, Top = 6, Text = "This is some text!", Name = "TextTest" };


            scope.Model.Scale = new Point(jQuery.Window.GetWidth() / (double)scope.Model.Game.GameLayout.Width * .9, ((jQuery.Window.GetHeight()) / (double)scope.Model.Game.GameLayout.Height) * .9);
