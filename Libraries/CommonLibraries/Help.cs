...
{ 
    ...
    public static class Json
    {
        ...
        public static object Parse(string json, JsonParseCallback parseCallback) { return null; }
        [ScriptName("parse")]
        [IgnoreGenericArguments]
        ...
        public static string Stringify(object o, string[] serializableMembers) { return null; }
        public static string Stringify(object o, string[] serializableMembers, int indentSpaces) { return null; }
        public static string Stringify(object o, string[] serializableMembers, string indentText) { return null; }
        public static string Stringify(object o, JsonStringifyCallback callback) { return null; }
        public static string Stringify(object o, JsonStringifyCallback callback, int indentSpaces) { return null; }
        public static string Stringify(object o, JsonStringifyCallback callback, string indentText) { return null; }
    }
}
