...
TableSpace = function (setter) {
    ...
    this.rotate = setter["rotate"] === undefined ? 0 : setter["rotate"];
...
Effect.Highlight = function (options) {
    this.offsetX =!options.offsetX ? 0 : options.offsetX;
    this.offsetY = !options.offsetY ? 0 : options.offsetY;
    this.rotate = !options.rotate ? 0 : options.rotate;
    this.radius = !options.radius ? 0 : options.radius;
    this.color = !options.color ? 'yellow' : options.color;
    this.opacity = !options.opacity ? 0 : options.opacity;
    this.type = 'highlight';
    return this;
};
