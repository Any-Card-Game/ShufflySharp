...
var $ShuffUI_ShuffListBox = function(x, y, width, height) {
	...
	but.jqxListBox({ source: this.items, width: CommonLibraries.Number.op_Implicit(width), height: CommonLibraries.Number.op_Implicit(height), theme: theme });
...
$ShuffUI_ShuffListBox.prototype = {
	...
	$update: function() {
		var theme = 'getTheme()';
		this.element.jqxListBox({ source: this.items, width: CommonLibraries.Number.op_Implicit(this.get_width()), height: CommonLibraries.Number.op_Implicit(this.get_height()), theme: theme });
	}
};
////////////////////////////////////////////////////////////////////////////////
// ShuffUI.ShuffListBox
